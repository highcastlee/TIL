...
### 여러 장애 환경
  ...
  2. 저시력 시각 장애
      ...
      <br/>
      <img src="https://user-images.githubusercontent.com/62092665/134769083-dccdf5f9-7ebc-4ed7-b11a-bd48ab4b463a.png" width="80%"/>
...
#### 검사항목 3번. 콘텐츠는 색에 관계없이 인식될 수 있어야 한다.
  - ![image](https://user-images.githubusercontent.com/62092665/134806244-199a685f-c954-44ce-8986-0f3db0585ec7.png)
...
#### 검사항목 4번. 지시 사항은 모양, 크기, 위치, 방향, 색, 소리 등에 관계 없이 인식될 수 있어야 한다. 
  - <img src="https://user-images.githubusercontent.com/62092665/134813652-04ee2c6c-1047-4379-ac87-b8bc874fd61c.png" width="60%">
  - 왼쪽 버튼, 작은 버튼, 파란 버튼 등의 방식으로 정보 제공하는 것을 피해야한다.


#### 검사항목 5번. 텍스트 콘텐츠와 배경 간의 명도 대비는 4.5 대 1 이상이어야 한다.
  - <img src="https://user-images.githubusercontent.com/62092665/134813835-985abc99-77b8-4fe2-90f1-276781c594f5.png" width="50%">
  - 텍스트와 배경 간의 명도 대비
...
#### 검사항목 7번. 이웃한 콘텐츠는 구별될 수 있어야 한다.
  - <img src="https://user-images.githubusercontent.com/62092665/134814065-71b7c49b-fae4-4b7a-bd64-7fee7f50f33c.png" width="50%">
  - <img src="https://user-images.githubusercontent.com/62092665/134814099-a343eabd-540d-421c-ab11-7652487560af.png" width="50%">
...
#### 검사항목 8번. 키보드 사용 보장
  ...
  - ##### case 3) 이미지 또는 초점을 받을 수 없는 요소에 마우스 이벤트 적용
    - <img src="https://user-images.githubusercontent.com/62092665/134814579-f526c74f-a821-44ee-a415-503ad2fe01c2.png" width="50%">
    ```html
    <!-- 키보드 접근 불가 -->
...
#### 검사항목 9번. 초점 이동
  ...
  - ##### case 1) 논리적 순서 이동
    ...
    <img src="http://www.websoul.co.kr/img/consulting/guide2_01_img01_y.png" width="70%">
  - ##### case 2) 레이어 팝업 초점 이동
    - 레이어 팝업 노출 시, 레이어 내부로 초점 이동 후, 닫힐 때 다시 레이어 컨트롤로 초점 이동
      <img src="https://user-images.githubusercontent.com/62092665/134815323-c42fb1f1-d1f5-4743-b3fb-e111e0e7b45f.png" width="30%">
...
#### 검사항목 11번. 응답 시간 조절
  - 시간제한이 있는 콘텐츠는 응답시간을 조절할 수 있어야 한다.
    ...
    <img src="http://www.websoul.co.kr/img/consulting/guide2_02_img01_y.png" width="50%">
...
#### 검사항목 12번. 정지 기능 제공
  ...
  - ##### case 1) 자동으로 변경되는 슬라이드
    - 이전, 다음, 정지 기능 제공
  <img src="https://nuli.navercorp.com/resources/img/guideline/g12_01.png" width="50%">

  - ##### case 2) 자동으로 변경되는 콘텐츠
    - 이전, 다음, 정지 기능이나 전체 보기 기능 제공
  <img src="https://nuli.navercorp.com/resources/img/guideline/g12_02.png" width="50%">

#### 검사항목 13번. 깜빡임과 번쩍임 사용 제한
  - **광과민성 발작 예방**
  - 초당 3~50 회 주기로 깜빡이거나 번쩍이는 콘텐츠를 제공하지 않아야 한다.
    <img src="http://www.websoul.co.kr/img/consulting/guide2_03_img01_y.png" width="50%">
...
#### 검사항목 14번. 반복 영역 건너뀌기
  ...
  - ##### case 1) 페이지마다 반복되는 영역이 있는 경우
    <img src="http://www.websoul.co.kr/img/consulting/guide2_04_img01_y.png" width="50%">
...
#### 검사항목 15번. 제목 제공
  ...
  - ##### case 1) 페이지 제목
    ...
    - 잘못된 사례 
      <img src="https://user-images.githubusercontent.com/62092665/134816704-0cd15ce9-0640-459c-888e-b02f2d17dee0.png" />
    - 옳은 사례
      <img src="https://user-images.githubusercontent.com/62092665/134816734-b812e501-808a-430a-9a96-fc70a4032f0f.png" />
...
#### 검사항목 16번. 적절한 링크 텍스트
  ...
  - ##### case 4) 썸네일 이미지
    ...
    <img src="https://nuli.navercorp.com/resources/img/guideline/g16_02.png">
    ```html
  ...
  - ##### case 5) 명확한 링크
    - 명확하게 링크의 설명을 제공한다.
    <img src="https://nuli.navercorp.com/resources/img/guideline/g16_04.png" width="300px">
...
#### 검사항목 18번. 사용자 요구에 따른 실행
  ...
  - ##### case 2) 화면은 가리는 레이어 팝업이 있을 경우, 최상단에 마크업
    - 화면을 가리지 않도록 상단에 제공한다.
      - 잘못된 예
      <img src="https://nuli.navercorp.com/resources/img/guideline/g18_02.png" width="50%">
      - 옳은 예
      <img src="https://nuli.navercorp.com/resources/img/guideline/g18_03.png" width="50%">

  - ##### case 3) 사전에 인식할 수 없는 새 창
    - 새 창이라는 것을 알 수 있도록 제공
      <img src="https://nuli.navercorp.com/resources/img/guideline/g18_04.png" width="50%">
    ```html
    <!-- 잘못된 예 -->
...
#### 검사항목 19번. 콘텐츠의 선형 구조
  ...
  - ##### case 1) 탭 콘텐츠
    - <em>제목-내용-제목-내용</em> 순서로 마크업하거나 <em>해당 내용에 대한 제목을 숨김 처리</em>로 제공한다.
      <img src="https://nuli.navercorp.com/resources/img/guideline/g19_01.png" width="50%">
    ```html
    <!-- 잘못된 예 -->
  ...
  - ##### case 2) 더보기가 존재하는 콘텐츠
    - 제목-내용-더보기 순서로 마크업한다.
      <img src="https://nuli.navercorp.com/resources/img/guideline/g19_02.png" width="50%">
